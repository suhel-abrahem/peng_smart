      ...
      child: DropdownButton2(
              ...
              children: [
                if (selectedValue != null || widget.hint != null)
                  Expanded(
                    flex: 6,
                    child: Tooltip(
                      message: widget.stringConverter
                          .call(selectedValue ?? widget.hint as T),
        ...
        items: (widget.items ?? [])
            .map((element) => DropdownMenuItem<T>(
                  ...
                  child: FittedBox(
                    fit: BoxFit.scaleDown,
                    child: Text(widget.stringConverter.call(element as T),
                        style: Theme.of(context).textTheme.labelLarge),
                  ),
                ))
            .toList(),
