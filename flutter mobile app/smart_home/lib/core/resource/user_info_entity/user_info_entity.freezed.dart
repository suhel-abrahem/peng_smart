...
mixin _$UserInfoEntity {
 ...
 String? get id; String? get name; String? get email; String? get phoneNumber; String? get avatarUrl; String? get token; String? get refreshToken; int? get expiresIn;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,email,phoneNumber,avatarUrl,token,refreshToken,expiresIn);

@override
String toString() {
  return 'UserInfoEntity(id: $id, name: $name, email: $email, phoneNumber: $phoneNumber, avatarUrl: $avatarUrl, token: $token, refreshToken: $refreshToken, expiresIn: $expiresIn)';
}
...
@useResult
$Res call({
 String? id, String? name, String? email, String? phoneNumber, String? avatarUrl, String? token, String? refreshToken, int? expiresIn
});
...
/// Create a copy of UserInfoEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = freezed,Object? email = freezed,Object? phoneNumber = freezed,Object? avatarUrl = freezed,Object? token = freezed,Object? refreshToken = freezed,Object? expiresIn = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String? name,  String? email,  String? phoneNumber,  String? avatarUrl,  String? token,  String? refreshToken,  int? expiresIn)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserInfoEntity() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.phoneNumber,_that.avatarUrl,_that.token,_that.refreshToken,_that.expiresIn);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String? name,  String? email,  String? phoneNumber,  String? avatarUrl,  String? token,  String? refreshToken,  int? expiresIn)  $default,) {final _that = this;
switch (_that) {
case _UserInfoEntity():
return $default(_that.id,_that.name,_that.email,_that.phoneNumber,_that.avatarUrl,_that.token,_that.refreshToken,_that.expiresIn);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String? name,  String? email,  String? phoneNumber,  String? avatarUrl,  String? token,  String? refreshToken,  int? expiresIn)?  $default,) {final _that = this;
switch (_that) {
case _UserInfoEntity() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.phoneNumber,_that.avatarUrl,_that.token,_that.refreshToken,_that.expiresIn);case _:
  return null;
...
class _UserInfoEntity implements UserInfoEntity {
  const _UserInfoEntity({this.id = "", this.name = "", this.email = "", this.phoneNumber = "", this.avatarUrl = "", this.token = "", this.refreshToken = "", this.expiresIn = 0});
...
/// Create a copy of UserInfoEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = freezed,Object? email = freezed,Object? phoneNumber = freezed,Object? avatarUrl = freezed,Object? token = freezed,Object? refreshToken = freezed,Object? expiresIn = freezed,}) {
