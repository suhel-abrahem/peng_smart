...
mixin _$ScheduleEntity {
 ...
 String? get id; String? get time; bool? get enabled;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ScheduleEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.time, time) || other.time == time)&&(identical(other.enabled, enabled) || other.enabled == enabled));
}
...
@override
String toString() {
  return 'ScheduleEntity(id: $id, time: $time, enabled: $enabled)';
}
...
@useResult
$Res call({
 String? id, String? time, bool? enabled
});
...
/// Create a copy of ScheduleEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? time = freezed,Object? enabled = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String? time,  bool? enabled)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ScheduleEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String? time,  bool? enabled)  $default,) {final _that = this;
switch (_that) {
case _ScheduleEntity():
return $default(_that.id,_that.time,_that.enabled);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String? time,  bool? enabled)?  $default,) {final _that = this;
switch (_that) {
case _ScheduleEntity() when $default != null:
return $default(_that.id,_that.time,_that.enabled);case _:
  return null;
...
class _ScheduleEntity implements ScheduleEntity {
  const _ScheduleEntity({this.id = "", this.time = "", this.enabled = false});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ScheduleEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.time, time) || other.time == time)&&(identical(other.enabled, enabled) || other.enabled == enabled));
}
...
/// Create a copy of ScheduleEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? time = freezed,Object? enabled = freezed,}) {
