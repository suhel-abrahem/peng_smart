...
@override
String toString() {
  return 'HomeModel(id: $id, name: $name, ownerId: $ownerId, role: $role, createdAt: $createdAt)';
}
...
class _HomeModel implements HomeModel {
  const _HomeModel({this.id = '', this.name = '', this.ownerId = '', this.role = '', this.createdAt = ''});
